const datosServicios = {
    /* INTERNET Y REDES */
    'red': { 
        t: 'Instalacion y configuracion de equipos de red', 
        d: 'Servicio que consiste en la instalación y posterior configuracion de equipos de red tales como routers y switches en los puestos de trabajo de los funcionarios. El servicio se asegura de mantener a los trabajadores conectados a la red municipal cubriendo todas sus dependencias.' 
    },
    'conred': { 
    ...
    'insimp': { 
        t: 'Instalacion de Impresoras, escaneres y plotters', 
    ...
    'consimp': { 
        ...
        d: 'Servicio encargado de mantener los equipos de impresion con sus respectivos consumibles operativos y reemplazarlos al momento de terminar su vida util, ademas, se dispone de proveer para los funcionarios con tóneres en los casos donde se dificulte realizar el reemplazo de estos como lo es en DIMAO y la oficina ubicada en Coya.' 
    },
    'confimp': { 
        t: 'Configuración de equipos de Impresión', 
        d: 'Gestion, configuracion y mantenimiento de los equipos de impresion.' 
    },
    'mantimp': { 
        t: 'Mantencion de Impresoras, escaneres y plotters', 
    ...
    /* TELEFONIA */
    'conftel': { 
        t: 'Instalacion y configuracion de telefonos IP', 
        d: 'Servicio que se encarga de proveer con telefonos IP a los funcionarios a lo largo del municipio. Abarca la instalación de los dispositivos en los puestos de trabajo y su posterior configuración.'
    },
    'anxtel': { 
        t: 'Gestion de anexos telefonicos', 
        d: 'Servicio encargado de disponer con anexos teléfonicos a los funcionarios de la municipalidad siempre que se realize la instalación de un dispositivo nuevo, solicitar un listado de los mismos o pedir un anexo en especifico.'
    },
    'mantel': { 
        t: 'Mantencion o continuidad operativa de telefonos IP', 
        d: 'Servicio que comprende el soporte de los dispositivos telefonicos, incluye la revisión y diagnóstico de los dispositivos, así además de la resolución de problemas comunes como lo es el reemplazo de cables, configuración básica o avanzada de los valores en los dispositivos y también la resolución de fallas con la comunicación como problemas de audio.'
    },
    'codetel': { 
        t: 'Asignacion de codigos de salida', 
        d: 'Servicio que consiste en asignarle a los funcionarios un codigo de salida para llamadas fuera de la red telefónica municipal siempre que sea solicitado.'
    },
    /* GESTIONAMIENTO DE IDENTIDAD */
    'ad': { 
        t: 'Creacion de cuentas para usuarios nuevos', 
    ...
    'firmail': { 
        t: 'Administracion de Firmas de Correo Electronico', 
        d: 'Servicio enfocado en proveer de un pie de firma para cada correo institucional dentro de la municipalidad el cual deberá llevar los datos de cada funcionario, incluyendo su nombre y apellido, cargo al que pertenece, dirección a la que pertenezca, edificio en el cual trabaja y su respectivo anexo telefónico en caso de disponer de uno. Ademas de poder realizar correcciones o cambios en caso de que alguna firma presente un error en su información o cuando sea necesario atribuirle dicha firma a un nuevo funcionario.'
    },
    'firmelec': { 
        t: 'Gestion de Firma Electronica avanzada', 
        d: 'Servicio encargado de disponer a los funcionarios de una firma electronica la cual sirve para autenticar documentos digitales y firmar acuerdos online con la misma validez legal que una firma manuscrita, pero de forma más rápida, segura y sin papel. Consiste en realizar la instalación de dicha firma en el equipo del funcionario designado. También se encarga de disponer soluciones en caso de que la firma presente alguna falla..'
    },
    'gestacnta': { 
        t: 'Gestion de cuentas ante baja de funcionario', 
    ...
    'recup': { 
        t: 'Respaldo y restauracion de Archivos municipales', 
    ...
    'geshar': { 
        t: 'Gestion general del hardware de Informatica', 
        d: 'Servicio correspondiente a todo el hardware adicional que no sean equipos computacionales, consiste en proveer, prestar o retirar dicho hardware como lo son perifericos, proyectores, adaptadores, etc.'
    },
    'diagpc': { 
    ...
    /* ASESORIA TECNICA */
    'evapc': { 
        t: 'Evaluacion para baja de activo', 
    ...
    'ases': { 
        t: 'Asesoria tecnica General', 
        d: 'Servicio que consiste en asesorar u orientar a funcionarios sobre temas relacionados al area de la informática cada vez que se solicite mediante un ticket o por llamada telefonica.'
    },
    'capa': { 
        t: 'Capacitaciones para funcionarios municipales', 
        d: 'Servicio encargado de la capacitación para funcionarios sobre temas relacionados al area de la Informática y de acuerdo a lo que se solicite instruir, apoyandose por medio de charlas presenciales y remotas organizadas con Google Meet'
    },
    'cothdw': { 
    ...
    /* WORKSPACE */
    'gmail': { 
        t: 'Administracion de correos institucionales', 
    ...
    'ggl': { 
        ...
        d: 'Servicio que contempla la asistencia para los funcionarios en los servicios de Google Workspace, tales como las herramientas de ofimatica que y el uso eficiente de herramientas como Forms, Calendar, Meet, Etc.'
    },
    'drive': { 
        t: 'Gestion de datos en Google Drive', 
        d: 'servicio especificamente enfocado en asistir con el uso de Google Drive, la organización de directorios usando la aplicación de escritorio y su sincronización.'
    },
